...
const { Header} = Layout;
// antd-icon
import { AreaChartOutlined, DollarOutlined, MediumCircleFilled, DockerOutlined, PieChartOutlined } from '@ant-design/icons';
// utils
...
const menuitems = [
    {key: "1", label: <Link to="/"><FormattedMessage id="header_menu_1"/></Link>, icon: <DollarOutlined style={{fontSize: 20}}/>},
    {key: "2", label: <FormattedMessage id="header_menu_2"/>, icon: <MediumCircleFilled style={{fontSize: 20}}/>, theme: "light", children:[
        ...
        return(
            <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
                <div className="uni-header-logo">
                    <AreaChartOutlined className='Image'/>
